...
(
 ...
 CONSTRAINT [FK_SPSCHEDE_2] FOREIGN KEY ([IDBRAND])  REFERENCES [BRANDS]([IDBRAND])
);
GO
...
(
 ...
 CONSTRAINT [FK_SPVALORESCHEDA_2] FOREIGN KEY ([IDSPCONTROLLO])  REFERENCES [SPCONTROLLI]([IDSPCONTROLLO])
);
GO
...
AS
BEGIN 
INSERT INTO SPVALORISCHEDE_LOG([IDSPVALORESCHEDA],[IDSPSCHEDA], [IDSPCONTROLLO],[CODICE],[DESCRIZIONE],[TIPO],[VALOREN],[VALORET],[VALORED],CANCELLATO, DATAMODIFICA, UTENTEMODIFICA) 
SELECT I.[IDSPVALORESCHEDA],I.[IDSPSCHEDA], I.[IDSPCONTROLLO],I.[CODICE],I.[DESCRIZIONE],I.[TIPO],I.[VALOREN],I.[VALORET],I.[VALORED],I.CANCELLATO, I.DATAMODIFICA, I.UTENTEMODIFICA FROM INSERTED I
END
