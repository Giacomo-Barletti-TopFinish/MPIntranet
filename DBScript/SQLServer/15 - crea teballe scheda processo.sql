...
INSERT INTO SPELEMENTI_LOG ([IDSPELEMENTO], [IDSPMASTER],[IDSPCONTROLLO],[SEQUENZA],[OBBLIGATORIO],[TIPOELEMENTO],[TESTO],CANCELLATO, DATAMODIFICA, UTENTEMODIFICA) 
SELECT I.[IDSPELEMENTO], I.[IDSPMASTER],I.[IDSPCONTROLLO],I.[SEQUENZA],I.[OBBLIGATORIO],I.[TIPOELEMENTO],I.[TESTO],I.CANCELLATO, I.DATAMODIFICA, I.UTENTEMODIFICA FROM INSERTED I
INNER JOIN DELETED D ON D.[IDSPELEMENTO]=I.[IDSPELEMENTO]
END
...
AS
BEGIN 
INSERT INTO SPSCHEDE_LOG([IDSPSCHEDA], [IDSPMASTER],[CODICE],[DESCRIZIONE],[ANAGRAFICA],[AREAPRODUZIONE],[TASK],[FOTO],CANCELLATO, DATAMODIFICA, UTENTEMODIFICA) 
SELECT I.[IDSPSCHEDA], I.[IDSPMASTER],I.[CODICE],I.[DESCRIZIONE],I.[ANAGRAFICA],I.[AREAPRODUZIONE],I.[TASK],I.[FOTO],I.CANCELLATO, I.DATAMODIFICA, I.UTENTEMODIFICA FROM INSERTED I
END
...
AS
BEGIN 
INSERT INTO SPVALORISCHEDE_LOG([IDSPVALORESCHEDA],[IDSPSCHEDA], [IDSPELEMENTO],[CODICE],[DESCRIZIONE],[TIPO],[VALOREN],[VALORET],[VALORED],[IMMAGINESRC],CANCELLATO, DATAMODIFICA, UTENTEMODIFICA) 
SELECT I.[IDSPVALORESCHEDA],I.[IDSPSCHEDA], I.[IDSPELEMENTO],I.[CODICE],I.[DESCRIZIONE],I.[TIPO],I.[VALOREN],I.[VALORET],I.[VALORED],I.[IMMAGINESRC],I.CANCELLATO, I.DATAMODIFICA, I.UTENTEMODIFICA FROM INSERTED I
END
