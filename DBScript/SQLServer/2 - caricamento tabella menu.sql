...
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values (49,40,'VERIFICA SCHEDE','VERIFICA SCHEDE',null,'/SCHEDEPROCESSO/VERIFICASCHEDE','',NULL,10);
