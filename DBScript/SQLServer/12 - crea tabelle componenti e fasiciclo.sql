...
AS
BEGIN 
INSERT INTO FASICICLO_LOG (IDFASECICLO,IDDIBA, DESCRIZIONE,IDCOMPONENTE,AREAPRODUZIONE,TASK,SCHEDAPROCESSO,COLLEGAMENTOCICLO,
PEZZIPERIODO,PERIODO,SETUP,ATTESA,MOVIMENTAZIONE,CANCELLATO, DATAMODIFICA, UTENTEMODIFICA) 
SELECT I.IDFASECICLO,I.IDDIBA, I.DESCRIZIONE,I.IDCOMPONENTE,I.AREAPRODUZIONE,I.TASK,I.SCHEDAPROCESSO,I.COLLEGAMENTOCICLO,
