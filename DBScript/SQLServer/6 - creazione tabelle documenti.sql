...
GO
 ...
 CREATE TABLE DOCUMENTI
   (	
	...
	FOREIGN KEY (IDBLOCCO) REFERENCES BLOCCHI (IDBLOCCO) ,
...
AS
BEGIN 
INSERT INTO DOCUMENTI_LOG (IDDOCUMENTO, IDTIPODOCUMENTO,[FILENAME],ESTENSIONE,DATI,IDESTERNA,TABELLAESTERNA,IDBLOCCO, CANCELLATO, DATAMODIFICA, UTENTEMODIFICA) 
SELECT I.IDDOCUMENTO, I.IDTIPODOCUMENTO,I.[FILENAME],I.ESTENSIONE,I.DATI,I.IDESTERNA,i.TABELLAESTERNA,I.IDBLOCCO, I.CANCELLATO, I.DATAMODIFICA, I.UTENTEMODIFICA FROM INSERTED I
END
...
BEGIN 
INSERT INTO DOCUMENTI_LOG (IDDOCUMENTO, IDTIPODOCUMENTO,[FILENAME],ESTENSIONE,DATI,IDESTERNA,TABELLAESTERNA,IDBLOCCO, CANCELLATO, DATAMODIFICA, UTENTEMODIFICA) 
SELECT I.IDDOCUMENTO, I.IDTIPODOCUMENTO,I.[FILENAME],I.ESTENSIONE,I.DATI,I.IDESTERNA,i.TABELLAESTERNA,I.IDBLOCCO, I.CANCELLATO, I.DATAMODIFICA, I.UTENTEMODIFICA FROM DOCUMENTI I
