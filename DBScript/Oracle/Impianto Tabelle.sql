...
CREATE UNIQUE INDEX IDX_BRAND_1 ON BRAND(CODICEGESTIONALE);
...
CREATE INDEX IDX_FASIPROCESSO_1 ON FASIPROCESSO(IDPROCESSO);
...
FOR EACH ROW
BEGIN
INSERT INTO FASIPROCESSO_LOG(IDFASEPROCESSO,IDPROCESSO,IDVASCA,DURATA,CORRENTE,SEQUENZA,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
(:NEW.IDFASEPROCESSO,:NEW.IDPROCESSO,:NEW.IDVASCA,:NEW.DURATA,:NEW.CORRENTE,:NEW.SEQUENZA,:NEW.CANCELLATO,:NEW.DATAMODIFICA,:NEW.UTENTEMODIFICA);
END;
