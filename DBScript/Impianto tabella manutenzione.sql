...
create or replace TRIGGER DITTA_LOG
AFTER INSERT OR UPDATE ON DITTA
FOR EACH ROW
BEGIN
INSERT INTO DITTA_LOG(IDDITTA,RAGIONESOCIALE,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
