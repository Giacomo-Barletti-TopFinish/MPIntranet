...
FOR EACH ROW
BEGIN
INSERT INTO MANUTENTORI_LOG(IDMANUTENTORE,NOME_COGNOME,ACCOUNT_,NOTA,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
...
FOR EACH ROW
BEGIN
INSERT INTO MACCHINE_LOG(IDMACCHINA,IDPADRE,DESCRIZIONE,SERIALE,NOTE,LUOGO,DATACOSTRUZIONE,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
