...
FOR EACH ROW
BEGIN
INSERT INTO MANUTENTORI_LOG(IDMANUTENTORE,IDDITTA,NOME_COGNOME,ACCOUNT_,NOTA,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
(:NEW.IDMANUTENTORE,:NEW.IDDITTA,:NEW.NOME_COGNOME,:NEW.ACCOUNT_,:NEW.NOTA,:NEW.CANCELLATO,:NEW.DATAMODIFICA,:NEW.UTENTEMODIFICA);
END;
