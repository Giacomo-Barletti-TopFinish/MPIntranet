...
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('92',90,'CANCELLA DOCUMENTO','Modifica un documento',null,'/DOCUMENTI/MODIFICADOCUMENTO','','A','92');
