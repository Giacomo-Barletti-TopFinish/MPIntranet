...
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('36','35','CREA IMPIANTI','crea un nuovo IMPIANTI',null,'/GALVANICA/CREAIMPIANTO','','A','26');
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('37','35','RIMUOVI IMPIANTI','cancella un IMPIANTI',null,'/GALVANICA/RIMUOVIIMPIANTO','','A','27');
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('38','35','MODIFICA IMPIANTI','modifica un IMPIANTI',null,'/GALVANICA/MODIFICAIMPIANTO','','A','28');
