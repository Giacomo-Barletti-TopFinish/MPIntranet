...
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('111','110','CREA DITTA','crea UNA UOVA DITTA',null,'/MANUTENZIONE/CREADITTA','','A','111');
