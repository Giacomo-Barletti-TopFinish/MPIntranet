...
-- MENU ARTICOLO
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('60',null,'ARTICOLO','GESTIONE TABELLE ARTICOLO',null,null,'fa fa-flask fa-lg',NULL,'60');
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('61',60,'SCHEDA','SCHEDA ARTICOLO',null,'/ARTICOLO/SCHEDA','',NULL,'61');
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('62','61','CREA ARTICOLO','crea un nuovo ARTICOLO',null,'/ARTICOLO/CREAARTICOLO','','A','62');
