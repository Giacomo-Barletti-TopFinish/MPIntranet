...
-- MENU FBV
Insert into MENU (IDMENU,IDMENUPADRE,ETICHETTA,DESCRIZIONE,ONCLICK,HREF,FONT,AZIONE,SEQUENZA) values ('300',null,'FBV','FBV',null,null,'fa fa-wrench fa-lg',NULL,'300');
