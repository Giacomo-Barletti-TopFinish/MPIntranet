...
FOR EACH ROW
BEGIN
INSERT INTO ELEMENTICOSTIPREVENTIVI_LOG(IDELEMENTOCOSTO,IDPREVENTIVOCOSTO,IDELEMENTOPREVENTIVO,RICARICO,COSTO,INCLUDIPREVENTIVO,IDESTERNA,TABELLAESTERNA,PEZZIORARI,QUANTITA,COSTOARTICOLO,PREZZO,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
(:NEW.IDELEMENTOCOSTO,:NEW.IDPREVENTIVOCOSTO,:NEW.IDELEMENTOPREVENTIVO,:NEW.RICARICO,:NEW.COSTO,:NEW.INCLUDIPREVENTIVO,:NEW.IDESTERNA,:NEW.TABELLAESTERNA,:NEW.PEZZIORARI,:NEW.QUANTITA,:NEW.COSTOARTICOLO,:NEW.PREZZO,:NEW.CANCELLATO,:NEW.DATAMODIFICA,:NEW.UTENTEMODIFICA);
END;
