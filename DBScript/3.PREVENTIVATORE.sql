...
CREATE UNIQUE INDEX IDX_MATERIAPRIMA_1 ON MATERIAPRIMA (CODICE);

 CREATE TABLE MATERIAPRIMA_LOG (  
  ...
  UTENTEMODIFICA VARCHAR2(50)  NULL
   ...
   create or replace TRIGGER MATERIAPRIMA_LOG
AFTER INSERT OR UPDATE ON MATERIAPRIMA 
FOR EACH ROW
BEGIN
INSERT INTO MATERIAPRIMA_LOG(IDMATERIAPRIMA,CODICE,DESCRIZIONE,IDMATERIALE,RICARICO,COSTO,INCLUDIPREVENTIVO,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
...
END;
 ...
 CREATE TABLE PRODOTTIFINITI_LOG (  
    ...
    IDBRAND NUMBER NULL , 
     IDCOLORE NUMBER NULL , 
     IDTIPOPRODOTTO NUMBER NULL,
    MODELLO VARCHAR(1) NULL,
     CODICE	VARCHAR2(30 BYTE) null,
  DESCRIZIONE VARCHAR2(80) NULL,
  CODICEDEFINITIVO VARCHAR2(15) NULL,
  CODICEPROVVISORIO VARCHAR2(15) NULL,
