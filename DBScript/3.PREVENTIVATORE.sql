...
FOR EACH ROW
BEGIN
INSERT INTO ELEMENTICOSTIPREVENTIVI_LOG(IDCOSTOPREVENTIVO,IDPREVENTIVOCOSTO,IDELEMENTOPREVENTIVO,RICARICO,COSTO,INCLUDIPREVENTIVO,IDESTERNA,TABELLAESTERNA,PEZZIORARI,QUANTITA,COSTOARTICOLO,PREZZO,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
