...
FOR EACH ROW
BEGIN
INSERT INTO ELEMENTIPREVENTIVO_LOG(IDELEMENTOPREVENTIVO,IDPREVENTIVO,IDPADRE,CODICE,DESCRIZIONE,IDREPARTO,RICARICO,COSTO,INCLUDIPREVENTIVO,IDESTERNA,TABELLAESTERNA,PEZZIORARI,PESO,SUPERFICIE,ARTICOLO,COSTOARTICOLO,QUANTITA,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
(:NEW.IDELEMENTOPREVENTIVO,:NEW.IDPREVENTIVO,:NEW.IDPADRE,:NEW.CODICE,:NEW.DESCRIZIONE,:NEW.IDREPARTO,:NEW.RICARICO,:NEW.COSTO,:NEW.INCLUDIPREVENTIVO,:NEW.IDESTERNA,:NEW.TABELLAESTERNA,:NEW.PEZZIORARI,:NEW.PESO,:NEW.SUPERFICIE,:NEW.ARTICOLO,:NEW.QUANTITA,:NEW.COSTOARTICOLO,:NEW.CANCELLATO,:NEW.DATAMODIFICA,:NEW.UTENTEMODIFICA);
END;
 ...
 CREATE TABLE COSTIFISSI (  
    IDCOSTIFISSI NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,  
    CODICE VARCHAR2(10) NOT NULL ,     
    DESCRIZIONE VARCHAR2(30) NULL ,
...
FOR EACH ROW
BEGIN
INSERT INTO COSTIFISSI_LOG(IDCOSTIFISSI,CODICE,DESCRIZIONE,COSTO,RICARICO,CANCELLATO,DATAMODIFICA,UTENTEMODIFICA)
VALUES
(:NEW.IDCOSTIFISSI,:NEW.CODICE,:NEW.DESCRIZIONE,:NEW.COSTO,:NEW.RICARICO,:NEW.CANCELLATO,:NEW.DATAMODIFICA,:NEW.UTENTEMODIFICA);
END;
...
END;
  ...
  UTENTEMODIFICA VARCHAR2(50) NOT NULL,
   ...
   FOREIGN KEY (IDPREVENTIVOCOSTO) REFERENCES PREVENTIVICOSTI (IDPREVENTIVOCOSTO) ENABLE,
   FOREIGN KEY (IDELEMENTOPREVENTIVO) REFERENCES ELEMENTIPREENTIVO (IDELEMENTOPREVENTIVO) ENABLE
   );
