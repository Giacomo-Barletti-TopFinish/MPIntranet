        ...
        public byte[] CaricoLavoroExcel(ReportDS ds)
        {
            ...
            using (SpreadsheetDocument document = SpreadsheetDocument.Create(ms, SpreadsheetDocumentType.Workbook))
            {
                ...
                foreach (ReportDS.ODL_APERTIRow odl_aperto in ds.ODL_APERTI)
                {
                    ...
                    rowDati.Append(ConstructCell(odl_aperto.IsNOMECOMMESSANull() ? string.Empty : odl_aperto.NOMECOMMESSA, CellValues.Number, 1));
                    ...
                    rowDati.Append(ConstructCell(odl_aperto.IsELENCOFASINull() ? string.Empty : odl_aperto.ELENCOFASI, CellValues.Number, 1));
